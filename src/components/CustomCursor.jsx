...
function CustomCursor() {
  ...
  useEffect(() => {
    ...
    // initial position off-screen + center transform
    gsap.set([cursor, cursorBorder], {
      xPercent: -50,
      yPercent: -50,
    });

    // smooth follow for inner dot
    ...
    return () => {
      ...
      // Optional: kill any in-flight tweens
      gsap.killTweensOf([cursor, cursorBorder]);
    };
  }, [isMobile]);
